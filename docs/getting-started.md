...
At v0.2.11 there are two install paths that work today, and three
...
The [v0.2.11 GitHub Release](https://github.com/hafizhpratama/stryx/releases/tag/v0.2.11)
...
curl -L https://github.com/hafizhpratama/stryx/releases/latest/download/stryx-0.2.11-x86_64-unknown-linux-gnu.tar.gz \
  | tar xz
./stryx-0.2.11-x86_64-unknown-linux-gnu/stryx scan
```
...
jobs:
  scan:
    ...
    steps:
      ...
      - run: |
          curl -L https://github.com/hafizhpratama/stryx/releases/latest/download/stryx-0.2.11-x86_64-unknown-linux-gnu.tar.gz | tar xz
          ./stryx-0.2.11-x86_64-unknown-linux-gnu/stryx scan --fail-on=high
```
