...
pub enum StepKind {
    ...
    SqlSink(sinks::SqlSink),
    ExecSink(sinks::ExecSink),
...
impl StepKind {
    pub fn as_source(&self, ctx: &StepCtx<'_, '_>, expr: &Expression<'_>) -> Option<TaintLabel> {
        match self {
            ...
            StepKind::SqlSink(s) => s.as_source(ctx, expr),
            StepKind::ExecSink(s) => s.as_source(ctx, expr),
    ...
    pub fn as_call_source(
        ...
        match self {
            ...
            StepKind::SqlSink(s) => s.as_call_source(ctx, call),
            StepKind::ExecSink(s) => s.as_call_source(ctx, call),
    ...
    pub fn as_member_source(
        ...
        match self {
            ...
            StepKind::SqlSink(s) => s.as_member_source(ctx, object, prop),
            StepKind::ExecSink(s) => s.as_member_source(ctx, object, prop),
    ...
    pub fn as_sink(&self, ctx: &StepCtx<'_, '_>, call: &CallExpression<'_>) -> Option<SinkSpec> {
        match self {
            ...
            StepKind::SqlSink(s) => s.as_sink(ctx, call),
            StepKind::ExecSink(s) => s.as_sink(ctx, call),
    ...
    pub fn as_sanitizer(&self, ctx: &StepCtx<'_, '_>, call: &CallExpression<'_>) -> bool {
        match self {
            ...
            StepKind::SqlSink(s) => s.as_sanitizer(ctx, call),
            StepKind::ExecSink(s) => s.as_sanitizer(ctx, call),
    ...
    pub fn as_propagator(&self, ctx: &StepCtx<'_, '_>, expr: &Expression<'_>) -> Option<PropSpec> {
        match self {
            ...
            StepKind::SqlSink(s) => s.as_propagator(ctx, expr),
            StepKind::ExecSink(s) => s.as_propagator(ctx, expr),
